...
public class SettingsActivity extends PreferenceActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    hideFilesFolders = (CheckBoxPreference) findPreference(
      getString(R.string.settings_hide_files_folders));
    hideFilesFolders
    ...
    releaseAccount =
      (Preference) findPreference(getString(R.string.settings_release_account));
    releaseAccount
      .setOnPreferenceClickListener(new OnPreferenceClickListener() {
        ...
        public boolean onPreferenceClick(Preference preference) {
          ...
          builder.setMessage(getString(R.string.release_account_hint))
            ...
            .setCancelable(false)
            .setPositiveButton(getString(R.string.release),
              new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                  ...
                  backToSetup.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK |
