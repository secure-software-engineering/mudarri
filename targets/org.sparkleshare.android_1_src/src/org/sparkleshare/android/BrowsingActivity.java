...
public class BrowsingActivity extends BaseActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    SharedPreferences prefs =
      SettingsActivity.getSettings((ContextWrapper) context);
    ...
    OnItemClickListener listener = new OnItemClickListener() {
                              ...
                              long id)
      {
        ...
        if (current.getType().equals("dir")) {
          ...
          String tmpUrl =
            serverUrl + "/api/getFolderContent/" + folderId + "?" +
              current.getUrl();
          ...
          SharedPreferences prefs =
            SettingsActivity.getSettings((ContextWrapper) parent.getContext());
          Editor editor = prefs.edit();
          editor.putString("folderId", folderId);
          editor.commit();
          browseFolder
            .putExtra("url", serverUrl + "/api/getFolderContent/" + folderId);
          browseFolder.putExtra("foldername", current.getTitle());
          startActivity(browseFolder);
  ...
  private class DownloadFileList
    extends AsyncTask<String, ListEntryItem, Boolean>
  {
    ...
    protected void onPostExecute(Boolean result) {
      ...
      if (isProjectsDirectory) {
        setupActionBarWithoutHomeButton(getString(R.string.projects),
          Color.WHITE);
        addNewActionButton(R.drawable.ic_action_info, R.string.info,
          new OnClickListener() {
...
//				});
        ...
        addNewActionButton(R.drawable.ic_action_refresh, R.string.refresh,
          new OnClickListener() {
