...
public class BatteryDog extends Activity {
  ...
  OnClickListener StartServiceListener = new OnClickListener() {
    public void onClick(View v) {
      try {
        BatteryDog batteryDog = BatteryDog.this;
        startService(new Intent(batteryDog, BatteryDog_Service.class));
      } catch (Exception e) {
        Log.e(TAG, e.getMessage(), e);
        Toast
          .makeText(BatteryDog.this, "Start Service failed: " + e.getMessage(),
  ...
  OnClickListener StopServiceListener = new OnClickListener() {
    public void onClick(View v) {
      try {
        ...
        Log.e(TAG, e.getMessage(), e);
        Toast
          .makeText(BatteryDog.this, "Stop Service failed: " + e.getMessage(),
            Toast.LENGTH_SHORT).show();
      }
    }
  };
  ...
  OnClickListener GraphListener = new OnClickListener() {
    public void onClick(View v) {
      BatteryDog batteryDog = BatteryDog.this;
      startActivity(new Intent(batteryDog, BatteryGraph.class));
    }
  };
